...
def movie():
    return input('Please enter a movie title: ')
...
def rating():
    return float(input("please enter a movie rating (1-5): "))
...
def review():
    return input('Please enter a brief review: ')
